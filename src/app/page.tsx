...
export default function Home() {
  ...
  <div className='flex flex-col gap-6'>
    ...
    <main className=" flex flex-col  bg-[#EF3434]  justify-center items-center gap-8 py-5 w-4/5 ">
    ...
    {/* body image section */}
    <div className="flex  justify-center items-center px-12 py-5">
      <div className="flex justify-between bg-[#EF3434]  py-8 rounded-md px-5">
        <span className="flex w-4/5 ">image</span>
        <div className="flex flex-col gap-6 ">
     ...
     <div className="flex bg-[#EF3434]  py-3 justify-between px-28">
    <div className="flex gap-5 ">
      ...
      <span className=" text-white ">
          ...
          <span className='text-white font-medium'>decore123@gmail.com</span> 
      </div>
      <div className="flex justify-center items-center gap-1 ">
      <span className=" text-white ">
            <svg
