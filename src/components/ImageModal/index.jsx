        ...
        <div className="absolute px-2 py-1 md:px-4 md:py-3 w-full flex justify-between">
          ...
          {!isError && (
            <div className=" flex gap-2 md:gap-4">
              <button
                className=" text-white rounded-full w-8 h-8 bg-black/50 flex items-center justify-center text-white/75 backdrop-blur-lg transition hover:bg-black/75 hover:text-white"
